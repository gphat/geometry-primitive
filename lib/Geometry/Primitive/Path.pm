package Geometry::Primitive::Path;
use Moose;
...
Geometry::Primitive::Path is a shape defined by a list of primitives.
=head1 SYNOPSIS

  use Geometry::Primitive::Path;

  my $path = Geometry::Primitive::Path->new();
